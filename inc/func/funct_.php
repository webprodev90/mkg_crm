...
*/
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/pmap/PHPMailer/src/Exception.php';
	require_once $_SERVER['DOCUMENT_ROOT'] . '/pmap/PHPMailer/src/PHPMailer.php';
	require_once $_SERVER['DOCUMENT_ROOT'] . '/pmap/PHPMailer/src/SMTP.php';
...
if ($code2 < 200 || $code2 > 204) die( "Error $code2. " . (isset($errors2[$code2]) ? $errors2[$code2] : 'Undefined error') );
	...
	} elseif($row2["id"] == '190' || $row2["id"] == '191' || $row2["id"] == '192' || $row2["id"] == '223' || $row2["id"] == '224' || $row2["id"] == '225' || $row2["id"] == '226' || $row2["id"] == '227' || $row2["id"] == '228'|| $row2["id"] == '254' || $row2["id"] == '255' || $row2["id"] == '266' || $row2["id"] == '269') {
