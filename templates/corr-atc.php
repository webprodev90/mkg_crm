...
function clean_phone_number($phone_number) {
  ...
  if(!empty($_POST['atc_id'])) {
	...
	$res3 = $db_connect3->query('SELECT `number` FROM `connections` WHERE vnum = "' . $atc_id . '" ORDER BY `id` DESC LIMIT 1');
