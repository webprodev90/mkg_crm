<?require_once BEZ_DOCR . '/templates/header.php'; 
/*
...
*/
					...
					} elseif ($_SESSION['login_role'] == "4" OR $_SESSION['login_role'] == "5") {	
						header('Location:'. BEZ_HOST . 'templates/pages/unprocessed-base-5.php?p=10');
					} elseif ($_SESSION['login_role'] == "10" OR $_SESSION['login_role'] == "11") {    
                        header('Location:'. BEZ_HOST . 'templates/pages/unprocessed-base-2.php?p=10');
                    } else {
...
?>
        ...
        <div id="wrapper">
			...
			<!-- Левое меню -->
			<?require_once BEZ_DOCR . '/templates/sidebar_left.php';?> 

            <div class="content-page">
			<!-- Верхнее меню -->
			<?require_once BEZ_DOCR . '/templates/sidebar_top.php';?> 
...
<?require_once BEZ_DOCR . '/templates/footer.php'; 
?>
