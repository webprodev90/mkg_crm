                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            <div class="row align-items-start">                                 
                                    <div class="col-12 mb-2 form-inline justify-content-center align-items-start" style="gap: 10px;">
                                        <?php if($_SESSION['login_role'] == 1 or $_SESSION['login_role'] == 4 or $_SESSION['login_role'] == 12 or $_SESSION['login_role'] == 13 or $_SESSION['login_id'] == 347) { ?>
                                    ...
                                    <div class="col-12 mb-2 form-inline justify-content-center align-items-baseline" style="gap: 10px;">
                                        <button class="btn calling-bg btn-operator-request" data-filter-type="calls-today">Созвоны на сегодня</button>    
                                        <button class="btn calling-bg btn-operator-request" data-filter-type="calls-all">Все созвоны</button>    
                                        <button class="btn lead-bg btn-operator-request" data-filter-type="leads-today">Лиды сегодня</button>    
                                        <button class="btn lead-bg btn-operator-request" data-filter-type="leads-all">Все лиды</button>                                   
                                    </div>
                                    <div class="col-12 mb-2 form-inline justify-content-center align-items-baseline" style="gap: 10px;">
                                        <button class="btn defect-bg btn-operator-request" data-filter-type="leads-saved">Ошибочно сохраненные</button>    
                                        <button class="btn hung-up-target-bg btn-operator-request" data-filter-type="hung-up-target">Сброс-целевой</button>                                    
                                    </div>
                        </div>
                        <div class="card-box">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="update-user-selected-rows.php" method="post" class="form-horizontal">
                    ...
                    <input type="hidden" id="selected_rows_status" name="selected_rows_status" value="32">
