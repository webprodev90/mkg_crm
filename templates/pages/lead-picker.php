...
require_once $_SERVER['DOCUMENT_ROOT'] . '/scripts/lead_picker/lead_picker.php';

if(!$_SESSION['login_role']) {
    header('Location: /'); 
}

$unprocessed_base_obj = new LeadPicker();
$curdate = date('Y-m-d');
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            <div class="mb-3 d-flex align-items-center justify-content-between">
                                <div class="d-flex">
                                    <div class="event_counter mr-3" status="12">
                                        Перезвоны <span class="count_callings">
                                            <?= $counters['callings']; ?>
                                        </span>
                                    </div>
                                    <div class="event_counter mr-3" status="4">
                                        Недозвоны <span class="count_non_calls">
                                            <?= $counters['non_calls']; ?>
                                        </span>
                                    </div>
                                    <div class="event_counter mr-3" status="2">
                                        Отказы <span class="count_rejections">
                                            <?= $counters['rejections']; ?>
                                        </span>
                                    </div>
                                    <div class="event_counter mr-3" status="3">
                                        Сбросы <span class="count_hung_up">
                                            <?= $counters['hung_up']; ?>
                                        </span>
                                    </div>
                                    <div class="event_counter mr-3" status="7">
                                        Не актуально <span class="count_not_relevant">
                                            <?= $counters['not_relevant']; ?>
                                        </span>
                                    </div>   
                                    <div class="event_counter mr-3" status="10">
                                        Новые лиды <span class="count_new_leads">
                                            <?= $counters['new_leads']; ?>
                                        </span>
                                    </div>                                   
...
<script src="/scripts/lead-picker.js"></script>