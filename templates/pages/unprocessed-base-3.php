                                ...
                                <div class="row align-items-start">
                                    <?php if($_SESSION['login_role'] == 1 or $_SESSION['login_role'] == 4 or $_SESSION['login_role'] == 12) { ?>
                                        <div class="col-12 form-inline justify-content-center align-items-start" style="gap: 10px;">
                                            <?php if($_SESSION['login_role'] == 1 or ($_SESSION['login_role'] == 4 and $_SESSION['login_id'] == 252) or $_SESSION['login_role'] == 12) { ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form target="_blank" action="/basep/parfbase_for_doubles.php" method="post" enctype="multipart/form-data"
