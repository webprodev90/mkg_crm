...
$res = $db_connect->query('SELECT `id`, `name_city` FROM `st_city_s`');	
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" action="update-city.php" method="POST">
...
<div id="signup-modal30" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				<h2 class="text-center m-b-30">Добавление города</h2>
				<form class="form-horizontal" action="create-city.php" method="POST">
					<input type="hidden" id="idval" name="idval">
					<div class="form-row">
                        <div class="form-group col-md-12">
                            <input type="text" class="form-control" id="name2" name="name2" placeholder="Город">
						</div>					
					</div>	
